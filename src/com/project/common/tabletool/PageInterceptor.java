...
public class PageInterceptor implements Interceptor {
	 ...
	 * 给当前的参数对象page设置总记录数
	 *
	 * @param pparameterObject
	 *            Mapper映射语句对应的参数对象，里边包含Page对象
	 * @param mappedStatement
	 *            Mapper映射语句
	 * @param connection
	 *            当前的数据库连接
	 */
	private void setTotalRecord(Object parameterObject, MappedStatement mappedStatement, Connection connection) {
